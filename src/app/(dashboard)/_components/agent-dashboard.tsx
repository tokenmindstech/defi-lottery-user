...
const AgentDashboard = () => {
  return (
    <section className="flex flex-col w-full h-full space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-bgtext-900 rounded-xl p-4">
          <h3 className="text-xl font-medium text-bgtext-100 mb-2">
            Referal Growth
          </h3>
          ...
          <div className="h-48 flex items-end space-x-2">
            ...
            {[
              ...
              <div key={month} className="flex flex-col items-center flex-1">
                <div
                  className={`w-full ${
                    index === 4 ? "bg-linprimary-start" : "bg-bgtext-800"
                  } rounded-t-sm`}
                  style={{
                    height: `${
                      index === 4
      ...
      <div className="bg-bgtext-900 rounded-xl p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <TrainingCard
            title="Crypto Basics"
            price="$29"
            bgGradient="from-bgtext-900 to-bgtext-800"
            tag="New"
          />
          <TrainingCard
...
const TrainingCard = ({ title, price, tag, bgGradient }: TrainingCardProps) => {
  return (
    <div
      className={`bg-gradient-to-br ${bgGradient} p-4 rounded-xl h-36 relative overflow-hidden`}
    >
      {tag && (
        <div className="absolute top-2 left-2 bg-bgtext-800/50 text-xs text-bgtext-100 px-2 py-1 rounded-md">
          {tag}
        </div>
      )}
