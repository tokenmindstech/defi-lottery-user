...
import { ChevronLeft, ChevronRight, Copy, Search, TextIcon as Telegram } from "lucide-react"
...
const ReferralsPage = () => {
  ...
  return (
    <section className="flex flex-col w-full h-full space-y-6">
      <h2 className="text-3xl font-medium text-bgtext-100 font-inter">My Referrals</h2>
      ...
      <div className="bg-bgtext-900 rounded-xl p-4">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-medium text-bgtext-100">Referred Users</h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {[
                { name: "John Doe", date: "05-05-2025 | 14:30:00", earning: "$1,000", tier: "Premium" },
                { name: "Jean Smith", date: "05-05-2025 | 14:30:00", earning: "$1,000", tier: "No Subscription" },
                { name: "Jack Jacob", date: "05-05-2025 | 14:30:00", earning: "$1,000", tier: "Basic" },
                { name: "Natalie Fernanda", date: "05-05-2025 | 14:30:00", earning: "$1,000", tier: "Basic" },
                { name: "Alexander Matt", date: "05-05-2025 | 14:30:00", earning: "$1,000", tier: "Premium" },
              ].map((referral, index) => (
