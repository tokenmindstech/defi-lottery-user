...
import SkeletonPrizeStats from "./_components/skeleton-prize-stats";
  ...
  return (
    <section className="flex flex-col w-full h-full space-y-10">
      ...
      <ResultDisplay
        ...
        error={error}
        data={claimStats}
        loadingComponent={<SkeletonPrizeStats />}
        dataErrorMessage="An error occurred while fetching claim statistics."
        loadingErrorMessage="Failed to load claim statistics. Please try again later."
      >
        {(claimStats) => (
