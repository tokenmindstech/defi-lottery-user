...
const WinnerBanner = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full space-y-5">
      ...
      >
        {(bonusWinners) =>
          bonusWinners.data.bonusWinners.length > 0 && (
            <div className="relative flex flex-row items-center justify-between w-full h-full p-4 space-x-5 overflow-visible transition-all duration-300 ease-out border-2 bg-gradient-to-b from-linprimary-start to-linprimary-end/50 text-bgtext-100 hover:bg-gradient-to-b border-bgtext-800 rounded-2xl">
              <div className="relative flex flex-row items-center space-x-2">
                <p className="text-sm font-light font-inter whitespace-nowrap">
                  Congratulations to{" "}
                </p>
                <RotatingText
              ...
              <div className="relative flex flex-row items-center">
                <p className="hidden text-sm font-medium lg:block font-inter whitespace-nowrap">
                ...
                <div className="relative w-[60px]">
                  <Image
                    ...
                    width={60}
                    height={60}
                    className="absolute right-0 z-10 object-cover rounded-lg shadow-lg -top-13"
                    draggable={false}
                    loading="lazy"
                  />
                </div>
