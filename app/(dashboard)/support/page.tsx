...
import SkeletonSupport from "./_components/skeleton-support";
  ...
  return (
    <section className="flex flex-col w-full h-full space-y-10">
      ...
      <ResultDisplay
        ...
        error={error}
        data={supportData}
        loadingComponent={<SkeletonSupport />}
        dataErrorMessage="An error occurred while fetching support tickets."
        loadingErrorMessage="Failed to load support tickets. Please try again later."
      >
        {(supportData) => (
